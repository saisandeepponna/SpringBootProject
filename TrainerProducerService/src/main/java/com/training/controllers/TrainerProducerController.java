...
public class TrainerProducerController {
	...
	public List<String> getTrainerBySkillset(@PathVariable("skillset") String skillset)
	{
	...
	public int UpdateMobileno(@PathVariable long mobileno,@PathVariable int trainercode )
	{
